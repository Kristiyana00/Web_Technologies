...
<body>
    ...
    <div class="row">
        ...
        <div class="request_grown_hat_section">
            <h3><i class="fa fa-graduation-cap" aria-hidden="true"></i> Заяви тога, шапка и алумни клубът</h3>
            <div class="request_grown_hat_content">
                <div id="request_grown_hat_content_1_wrapper">
                    <div id="request_grown_hat_content_1">
                        <p id="grown_request"><i>Статус на заявката: неизбрал</i></p>
                ...
                <div id="request_grown_hat_content_2_wrapper">
                    <div id="request_grown_hat_content_2">
                        <p id="hat_request"><i>Статус на заявката: неизбрал</i></p>
                        <select class="hat_request_select" id="hat_request_select" onchange="requestHat('<?php echo $email ?>', this.value)">
                            ...
                            <option value="1" >Желая да участвам.</option>
                            <option value="0" >Не желая.</option>
                        </select>
                        <p id="hat_taken"></p>
                ...
                <div id="request_grown_hat_content_2_wrapper">
                    <div id="request_grown_hat_content_2">
                        <p id="participate_alumni"><i>Статус на заявката: неизбрал</i></p>
                        <select class="hat_request_select" id="hat_request_select" onchange="alumniParticipate('<?php echo $email ?>', this.value)">
                            <option value="-1" selected disabled hidden>Алумни клубът</option>
                            <option value="1" >Желая да участвам.</option>
                            <option value="0" >Не желая да участвам.</option>
                        </select>
...
<script>
    ...
    function buildContent(user) {
        ...
        document.getElementById("participate_alumni").innerHTML = "Статус: " + (user.student_alumni == 1 ? "Ще участвам" : "Няма да участвам");
          
        
        console.log(user.student_alumni);
    }

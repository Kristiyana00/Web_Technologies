...
<body>
    ...
    <div class="row">
        ...
        <div id="analytic_section">
            <div id="changeCharts">
                <select id="selectAnalyticsDiv" class="dashboard-action">
                    <option value="1">Горе ляво</option>
                    <option value="2">Горе дясно</option>
                    <option value="3">Долу ляво</option>
                    <option value="4">Долу дясно</option>
                </select>
                <select id="selectDataToBeDisplayed" class="dashboard-action">
                    <option value="1">Оценки</option>
                    <option value="2">Право на диплома</option>
                    <option value="3">Степен на образование</option>
                    <option value="4">Специалност</option>
                    <option value="5">Заявка тога</option>
                    <option value="6">Заявка шапка</option>
                    <option value="7">Алумни клуб</option>
                </select>
                <button id="showStatistic" class="submit-action" onclick="ShowStatistic()">Покажи статистиката</button>
            </div>
        <div id="insideAnalytics" style="display:flex;">
